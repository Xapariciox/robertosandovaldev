                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        ...
                        <p className={`  ${style.text}`}>
                            ...
                            <strong>nodeJs</strong> via <strong>mongoDB</strong>{' '}
                            connected with a <strong>Rest API</strong> via{' '}
                            ...
                            clean code, SOLID pattern and <strong>TDD</strong>{' '}
                            principles for testing with which I achieve{' '}
